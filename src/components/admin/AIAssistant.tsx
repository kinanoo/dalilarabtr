...
const QUICK_COMMANDS = [
  { label: 'عدد المقالات حسب القسم', prompt: 'كم مقال في كل قسم؟' },
  { label: 'مقالات بدون صور', prompt: 'ابحث عن مقالات بدون صورة' },
  { label: 'أحدث الأخبار', prompt: 'اعرض آخر 5 أخبار' },
  { label: 'خدمات بانتظار الموافقة', prompt: 'كم خدمة حالتها pending؟' },
];
