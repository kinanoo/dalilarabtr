...
const QUICK_COMMANDS = [
  { label: 'إحصائيات الموقع', prompt: 'أعطني نظرة عامة على الموقع — إحصائيات كل شي' },
  { label: 'المقالات حسب القسم', prompt: 'كم مقال في كل قسم؟' },
  { label: 'أحدث الأخبار', prompt: 'اعرض آخر 5 أخبار' },
  { label: 'تعليقات بانتظار', prompt: 'اعرض التعليقات المعلقة بانتظار الموافقة' },
  { label: 'خدمات معلقة', prompt: 'كم خدمة بانتظار الموافقة؟ اعرضها' },
  { label: 'آخر المقالات', prompt: 'اعرض آخر 10 مقالات مع أقسامها' },
];
