...
export default function FeaturedGuides({ guides }: { guides: FeaturedGuide[] }) {
    ...
    return (
        <section className="relative bg-gradient-to-b from-emerald-50/45 via-surface-light to-white dark:from-slate-950 dark:via-slate-950 dark:to-slate-950 pt-4 pb-4" dir="rtl">
