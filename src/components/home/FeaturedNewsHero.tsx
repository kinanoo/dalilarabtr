            ...
            <div className="relative max-w-6xl mx-auto px-4">
                <div className="grid lg:grid-cols-[1fr_auto] gap-6 lg:gap-10 items-center">
                    ...
                    <Link href={href} className="block group">
                        ...
                        {/* The headline — large, tight, attention-stealing */}
                        <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black leading-[1.15] text-white drop-shadow-lg group-hover:text-rose-100 transition-colors">
                            {article.title}
                        </h2>
