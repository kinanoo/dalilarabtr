    ...
    >
      ...
      <div className="mt-3 flex items-center gap-2">
        <Link
          href="/services/add"
          onClick={dismiss}
          className="inline-flex h-11 flex-1 items-center justify-center gap-2 rounded-xl bg-slate-950 px-4 text-sm font-black text-white transition hover:bg-emerald-700 active:scale-[0.98] dark:bg-emerald-600 dark:hover:bg-emerald-500"
        >
          أضف خدمتك
          <ArrowLeft size={16} />
        </Link>
