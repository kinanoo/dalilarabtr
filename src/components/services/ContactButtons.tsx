    ...
    return (
        <>
            ...
            <DirectWhatsAppLink
                ...
                className={`${compact ? 'h-10 px-3 sm:px-4' : 'flex-1 py-2.5'} ${subtle ? 'border border-slate-200 bg-white text-emerald-700 hover:border-emerald-300 hover:bg-emerald-50 dark:border-slate-700 dark:bg-slate-900 dark:text-emerald-300 dark:hover:bg-emerald-950/30' : 'bg-emerald-600 text-white shadow-sm shadow-emerald-600/20 hover:bg-emerald-700'} inline-flex items-center justify-center gap-1.5 rounded-xl text-xs font-black transition-all active:scale-95`}
            >
