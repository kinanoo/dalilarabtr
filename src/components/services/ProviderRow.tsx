        ...
        >
            ...
            <div className="flex items-center gap-1.5 shrink-0">
                <Link
                    ...
                    className="inline-flex h-10 items-center justify-center gap-1 rounded-xl bg-slate-950 px-3 text-xs font-black text-white transition hover:bg-emerald-700 active:scale-[0.98] dark:bg-slate-100 dark:text-slate-950 dark:hover:bg-emerald-500 dark:hover:text-white"
                >
