        ...
        >
            ...
            <div className="mt-3 flex items-center gap-2 border-t border-slate-100 pt-3 dark:border-slate-800">
                <Link
                    ...
                    className="inline-flex h-10 flex-1 items-center justify-center gap-1.5 rounded-xl bg-slate-950 px-4 text-xs font-black text-white transition-all hover:bg-emerald-700 active:scale-[0.98] dark:bg-slate-100 dark:text-slate-950 dark:hover:bg-emerald-500 dark:hover:text-white sm:h-[42px]"
                >
                    عرض التفاصيل
