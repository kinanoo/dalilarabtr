...
export const metadata: Metadata = {
    ...
    description:
        'دليل مواقع القنصليات والسفارات العربية والأجنبية وإدارات الهجرة ودوائر النفوس والضرائب والطابو والمحاكم في تركيا — كل مقر بضغطة واحدة على خرائط جوجل، بالموقع الحقيقي المحدّث.',
    keywords:
...
const FAQS = [
    {
        ...
        a: 'اكتب «القنصلية السورية في إسطنبول» في مربع البحث أعلى الصفحة (أو في بحث الصفحة الرئيسية) واضغط زر «خرائط» بجانب النتيجة — يفتح موقع القنصلية مباشرة على خرائط جوجل مع الاتجاهات ورقم الهاتف وساعات العمل المسجّلة. ونفس الطريقة تعمل لقنصلية غازي عنتاب والقنصليات المصرية والسعودية وبقية المقرات.',
    },
    {
        q: 'هل العناوين والمواقع محدّثة؟',
        a: 'نعم، وبشكل دائم: نحن لا نخزّن عناوين ثابتة قد تتغيّر، بل نفتح لك بحثاً حياً في خرائط جوجل باسم الجهة الرسمي. فلو نقلت القنصلية أو الدائرة مقرّها، يظهر لك الموقع الجديد فوراً — وكذلك رقم الهاتف وساعات العمل كما هي مسجّلة اليوم.',
    },
    {
        q: 'ما الفرق بين مقر محدّد و«الأقرب إليك»؟',
        a: 'السفارات والقنصليات مقرّات محدّدة، فالرابط يفتح ذلك المبنى بالتحديد. أما الدوائر الحكومية (النفوس، الضرائب، الطابو، النوتر، البريد...) فلها فروع كثيرة في كل ولاية، لذلك يفتح الرابط قائمة الفروع القريبة من موقعك الحالي — وهو ما تحتاجه فعلاً: الأقرب، لا فرعاً بعيداً.',
    },
    {
            ...
            <div className="max-w-6xl mx-auto px-4 pb-14 w-full space-y-6">
                ...
                <section className="relative overflow-hidden bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-6">
                    ...
                    <ol className="space-y-2.5 text-sm text-slate-600 dark:text-slate-300 list-decimal list-inside leading-relaxed">
                        ...
                        <li>اضغط زر <strong>«خرائط»</strong> بجانب النتيجة — يفتح الموقع فوراً على خرائط جوجل مع الاتجاهات.</li>
                        <li>أو افتح صفحة المقر لترى ماذا تنجز فيه، رابطه الرسمي، ورابط حجز الموعد إن وُجد.</li>
                    </ol>
                    <div className="mt-4 flex flex-wrap items-center gap-x-5 gap-y-2 text-[11px] text-slate-500 dark:text-slate-400">
                        <span className="flex items-center gap-1"><ShieldCheck className="w-3.5 h-3.5 text-emerald-600" /> الموقع من خرائط جوجل مباشرة — لا عناوين قديمة مخزّنة عندنا</span>
