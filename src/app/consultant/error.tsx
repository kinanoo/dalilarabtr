...
export default function ArticleError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-[60vh] px-4 text-center">
            ...
            <h2 className="text-2xl font-bold text-slate-800 dark:text-slate-100 mb-2">تعذّر تحميل دليل المواقف</h2>
            <p className="text-slate-500 dark:text-slate-400 mb-6 max-w-md">حدث خطأ أثناء تحميل دليل المواقف. جرّب مرة أخرى.</p>
