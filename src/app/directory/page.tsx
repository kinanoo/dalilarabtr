...
import { FileText, FolderOpen, ArrowLeft, Sparkles, Calendar, Loader2, ChevronDown, ChevronUp, IdCard, Plane, Briefcase, HeartPulse, GraduationCap, Link2, ShieldAlert, Calculator, BookOpen, Bell, Smartphone, MapPin, BrainCircuit, Home, Scale, Coffee, Users } from 'lucide-react';
...
const ADDITIONAL_SECTIONS: Array<{ key: string; title: string; description: string; href: string; icon: any; color: string }> = [
  ...
  { key: 'faq', title: 'الأسئلة الشائعة', description: 'أكثر من 600 سؤال وجواب حول القوانين والإجراءات', href: '/faq', icon: BookOpen, color: 'bg-green-500 dark:bg-green-600' },
  ...
  { key: 'e-devlet', title: 'دليل خدمات الدولة', description: 'شرح مفصل لخدمات البوابة الإلكترونية الحكومية', href: '/e-devlet-services', icon: Smartphone, color: 'bg-teal-500 dark:bg-teal-600' },
...
export default function DirectoryPage() {
  ...
  return (
    <main className="flex flex-col min-h-screen">
      ...
      <PageHero
        title="الدليل الشامل"
        description="فهرس كامل لكل مقالات وأدلة وخدمات الموقع."
