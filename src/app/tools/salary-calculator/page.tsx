...
export const metadata: Metadata = {
    ...
    description: 'حاسبة مجانية لتحويل الراتب من الإجمالي (Brüt) إلى الصافي (Net) والعكس في تركيا 2026: تفصيل اقتطاع الضمان (SGK 14%)، البطالة (1%)، ضريبة الدخل، وضريبة الطابع — بأرقام رسمية محدّثة وصافي كل شهر عبر السنة.',
