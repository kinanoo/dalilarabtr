...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
    ...
    const description = `كل ما يحتاجه العرب في ${city.ar}: مقدّمو خدمات عرب موثوقون، حالة الأحياء المغلقة لتسجيل الأجانب، وأدلّة الإقامة والعمل والأوراق الرسمية — محدّث 2026.`;
    return {
    ...
    return (
        <main className="flex flex-col min-h-screen font-cairo bg-slate-50 dark:bg-slate-950" dir="rtl">
            ...
            <PageHero
                ...
                description={`مقدّمو خدمات عرب موثوقون، حالة الأحياء المغلقة، وأدلّة الإقامة والعمل في ${city.ar}.`}
