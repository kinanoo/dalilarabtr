...
export const SERVICE_CATEGORIES: ServiceCategory[] = [
    ...
    {
        slug: 'home-maintenance', name: 'صيانة منزلية', labelAr: 'الصيانة المنزلية', variants: ['صيانة منزلية', 'خدمات منزلية', 'home', 'home maintenance', 'ev bakım'],
        keywords: ['صيانة منزلية عربية تركيا', 'فني منزلي اسطنبول', 'تركيب وإصلاح منزل', 'ev bakım servisi'],
        blurb: 'إصلاحات وتركيب وصيانة عامة للمنزل',
        guide: {
            intro: 'الأعمال المنزلية الصغيرة تصبح مكلفة عند غموض المطلوب. أرسل صور العطل واتفق على أجرة الزيارة والعمل قبل حضور الفني.',
            checklist: [
                'وضّح المطلوب بالصور والمقاسات قبل تحديد الموعد.',
                'اسأل إن كانت المواد والقطع مشمولة في السعر.',
                'اطلب ضماناً واضحاً على الإصلاح أو التركيب.',
            ],
        },
    },
    {
        slug: 'finishing-decor', name: 'تشطيبات وديكور', labelAr: 'التشطيبات والديكور', variants: ['تشطيبات وديكور', 'تشطيبات', 'ديكور', 'سيراميك', 'دهان', 'بلاط', 'decoration', 'seramik', 'boya'],
        keywords: ['معلم سيراميك عربي تركيا', 'دهان وديكور اسطنبول', 'تشطيب منازل تركيا', 'seramik ustası', 'boyacı'],
        blurb: 'سيراميك ودهان وديكور وتشطيب داخلي',
        guide: {
            intro: 'التشطيب الجيد يحتاج مقاسات دقيقة واتفاقاً مكتوباً على المواد والمدة. عاين عملاً سابقاً قبل تسليم دفعة كبيرة.',
            checklist: [
                'اطلب عرضاً يفصل أجرة اليد عن ثمن المواد.',
                'حدّد نوع المادة واللون والمساحة وموعد التسليم كتابةً.',
                'قسّم الدفعات بحسب مراحل العمل المنجزة.',
            ],
        },
    },
    {
        slug: 'locksmith-metalwork', name: 'حدادة وأقفال', labelAr: 'الحدادة والأقفال', variants: ['حدادة وأقفال', 'حداد', 'أقفال', 'مفاتيح', 'locksmith', 'metalwork', 'çilingir', 'demirci'],
        keywords: ['حداد عربي تركيا', 'فتح أقفال اسطنبول', 'نسخ مفاتيح عربي', 'çilingir'],
        blurb: 'فتح أقفال ومفاتيح وأعمال حدادة',
        guide: {
            intro: 'خدمات فتح الأقفال قد تكون طارئة؛ اطلب السعر قبل بدء العمل ولا تسمح بتبديل القطع من دون موافقتك.',
            checklist: [
                'اسأل عن أجرة الوصول والفتح قبل إرسال العنوان.',
                'احتفظ بالقطعة القديمة عند تبديل القفل.',
                'في أعمال الحدادة، اتفق على المقاسات والخامة وموعد التركيب.',
            ],
        },
    },
    {
        slug: 'telecom-internet', name: 'اتصالات وإنترنت', labelAr: 'الاتصالات والإنترنت', variants: ['اتصالات وإنترنت', 'اتصالات', 'إنترنت', 'انترنت', 'تركيب خطوط نت', 'خطوط نت', 'telecom', 'internet'],
        keywords: ['تركيب انترنت تركيا', 'خطوط هاتف عربية تركيا', 'نقل خط انترنت اسطنبول', 'internet aboneliği'],
        blurb: 'تركيب ونقل وإلغاء خطوط الهاتف والإنترنت',
        guide: {
            intro: 'قبل طلب خط هاتف أو إنترنت، تأكد من اسم الشركة والعقد والالتزام الشهري؛ لا تسلّم رمز تحقق لأي وسيط.',
            checklist: [
                'اطلب نسخة من العقد باسم الشركة المشغّلة والسعر الشهري.',
                'تحقق من مدة الالتزام وغرامة الإلغاء قبل التوقيع.',
                'لا تشارك رمز SMS أو كلمة مرور e-Devlet مع أي شخص.',
            ],
        },
    },
    {
        slug: 'phones-computers', name: 'تقنية وصيانة هواتف', labelAr: 'التقنية والهواتف', variants: ['تقنية وصيانة هواتف', 'تقنية', 'هواتف', 'كمبيوتر', 'صيانة جوال', 'technology', 'computer', 'telefon'],
        keywords: ['صيانة هواتف عربية تركيا', 'تصليح كمبيوتر اسطنبول', 'محل جوالات عربي'],
        blurb: 'صيانة هواتف وحواسيب وخدمات تقنية',
        guide: {
            intro: 'قبل تسليم هاتفك أو حاسوبك للصيانة، انسخ ملفاتك المهمة واحمِ حساباتك واتفق على تكلفة الفحص.',
            checklist: [
                'اسأل عن سعر الفحص وهل يُخصم عند الإصلاح.',
                'لا تسلّم كلمات مرور حساباتك إلا عند الضرورة وبعد تسجيل الخروج.',
                'اطلب ضماناً على القطعة الجديدة والفاتورة.',
            ],
        },
    },
    {
        slug: 'printing-design', name: 'طباعة وتصميم', labelAr: 'الطباعة والتصميم', variants: ['طباعة وتصميم', 'طباعة', 'تصميم', 'إعلانات', 'printing', 'design', 'matbaa'],
        keywords: ['مطبعة عربية تركيا', 'تصميم وطباعة اسطنبول', 'طباعة كروت ولوحات'],
        blurb: 'طباعة وتصميم وإعلانات ولافتات',
        guide: {
            intro: 'في أعمال الطباعة، اعتمد نسخة تجريبية واضحة قبل طباعة الكمية النهائية وحدد المقاس والخامة والألوان.',
            checklist: [
                'راجع الإملاء والأرقام على نموذج نهائي قبل الموافقة.',
                'حدّد الكمية والمقاس والخامة وموعد التسليم في الطلب.',
                'احتفظ بملف التصميم الأصلي إن كان ضمن السعر.',
            ],
        },
    },
    {
        slug: 'retail-supplies', name: 'متاجر ومستلزمات', labelAr: 'المتاجر والمستلزمات', variants: ['متاجر ومستلزمات', 'مستلزمات', 'مستلزمات اطفال', 'متاجر', 'بيع بالتجزئة', 'retail', 'supplies', 'mağaza'],
        keywords: ['متاجر عربية تركيا', 'مستلزمات أطفال عنتاب', 'محلات عربية قريبة'],
        blurb: 'متاجر ومستلزمات يومية ومتخصصة',
        guide: {
            intro: 'قارن السعر وسياسة الاستبدال، خصوصاً للمنتجات الكبيرة أو التي تحتاج ضماناً وصيانة.',
            checklist: [
                'اطلب فاتورة أو إيصالاً واضحاً لكل منتج.',
                'تحقق من مدة الضمان وشروط الاستبدال.',
                'للطلب عن بعد، لا تحول المبلغ كاملاً قبل التحقق من المتجر.',
            ],
        },
    },
    {
        slug: 'transport-taxi', name: 'نقل وتكسي', labelAr: 'النقل والتكسي', variants: ['نقل وتكسي', 'تكسي', 'تاكسي', 'نقل ركاب', 'سائق', 'transport', 'taxi', 'transfer'],
        keywords: ['تكسي عربي تركيا', 'سائق عربي اسطنبول', 'نقل مطار اسطنبول', 'havaalanı transfer'],
        blurb: 'سائقون ونقل ركاب وتوصيل مطارات',
        guide: {
            intro: 'للتوصيل بين المدن أو المطار، اتفق على السعر الكلي ونقطة الالتقاء وعدد الحقائب قبل الانطلاق.',
            checklist: [
                'أرسل موقع الالتقاء والوجهة كتابةً.',
                'تأكد أن السعر يشمل الطرق والجسور والانتظار.',
                'شارك بيانات الرحلة مع شخص تعرفه عند السفر الطويل.',
            ],
        },
    },
    {
        slug: 'employment', name: 'توظيف وعمالة', labelAr: 'التوظيف والعمالة', variants: ['توظيف وعمالة', 'توظيف', 'عمالة', 'فرص عمل', 'employment', 'recruitment', 'iş bulma'],
        keywords: ['مكتب توظيف عربي تركيا', 'عمالة عربية اسطنبول', 'فرص عمل للسوريين تركيا'],
        blurb: 'مكاتب توظيف وعمالة وخدمات أصحاب الأعمال',
        guide: {
            intro: 'لا تدفع مقابل وعد بوظيفة غير موثق. اطلب اسم صاحب العمل والعقد وساعات العمل والأجر قبل تسليم أوراقك.',
            checklist: [
                'تحقق من اسم الشركة ومكان العمل والعقد قبل البدء.',
                'لا تدفع رسوماً كبيرة مقدماً مقابل فرصة عمل.',
                'لا تسلّم أصل الإقامة أو الجواز لأي وسيط.',
            ],
            note: 'تصريح العمل يصدر عبر الجهات الرسمية وبطلب صاحب العمل؛ لا يوجد وسيط يستطيع ضمانه خارج الإجراء النظامي.',
        },
    },
    {
