...
export const ARABIC_SYNONYMS: Record<string, string[]> = {
    ...
    // 🔄 نقل / تحويل
    'نقل': ['تحويل', 'تغيير', 'تبديل'],
    'تحويل': ['نقل', 'تغيير', 'تبديل'],
...
const NOISE_WORDS = new Set([
    'بدي', 'اريد', 'ابي', 'ابغى', 'عايز', 'لازم', 'ضروري', 'كيف', 'طريقة', 'شرح',
    'هل', 'يوجد', 'ممكن', 'لو', 'سمحت', 'عند', 'عندي', 'لي', 'لنا', 'في', 'من', 'على', 'الي', 'الى',
    'شو', 'ما', 'هو', 'هي', 'انا', 'نحن', 'انت', 'انتم', 'هم', 'هن',
    'بخصوص', 'موضوع', 'عن', 'حول', 'ماهو', 'ماهي', 'كم', 'متى', 'اين', 'وين', 'ليش', 'لماذا',
