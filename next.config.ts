...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: '/article/highschool-denklik', destination: '/article/high-school-equivalency-turkey-2026', permanent: true },
      { source: '/article/school-equivalency', destination: '/article/high-school-equivalency-turkey-2026', permanent: true },
